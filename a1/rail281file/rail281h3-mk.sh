...
# This is has multiple autocomplete. 2017-12-07

# this is good.
#
#
# jqui autocomplete for rails 4
...
#
#   rail281file/rail281h3-mk.sh 2>&1 | tee -a ./rail-mk.sh.log
...
cp $sfil/product1.sj app/assets/javascripts
